...
wrapper library.
 ...
 =======
	...
	include('../../../../app_demo/lib/adodb5/session/old/adodb.inc.php');
	#---------------------------------#
	include('../../../../app_demo/lib/adodb5/session/old/adodb-cryptsession.php'); 
	#---------------------------------#
	session_start();
...
include_once('../../../../app_demo/lib/adodb5/session/old/crypt.inc.php');

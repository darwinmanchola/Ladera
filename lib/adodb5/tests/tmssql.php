...
function tpear()
{
include_once('../../../app_demo/lib/adodb5/tests/DB.php');
...
function tadodb()
{
include_once('../../../app_demo/lib/adodb5/adodb.inc.php');
...
?>
<a href=../../../app_demo/lib/adodb5/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../../app_demo/lib/adodb5/tests/tmssql.php?do=tpear>pear</a>
<a href=../../../app_demo/lib/adodb5/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	switch($do) {
